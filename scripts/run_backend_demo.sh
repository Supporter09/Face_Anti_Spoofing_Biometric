...
MODEL_PATH="${LIVENESS_MODEL_PATH:-${ROOT_DIR}/Kaggle_Outputs/celeba_spoof_training_full/best_model_scripted.pt}"
...
export LIVENESS_SPOOF_THRESHOLD="${LIVENESS_SPOOF_THRESHOLD:-0.10}"
export LIVENESS_LIVE_THRESHOLD="${LIVENESS_LIVE_THRESHOLD:-0.80}"
